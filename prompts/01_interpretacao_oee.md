Você é um analista de dados industriais com foco em desempenho operacional em fábricas de ração.

Com base no cenário e nos resultados abaixo, faça uma interpretação técnica e objetiva dos fatores associados ao OEE.

Quero que você:
1. identifique os principais achados;
2. explique o significado prático dos coeficientes;
3. interprete as diferenças entre os turnos;
4. destaque limitações do modelo;
5. sugira quais tipos de dados adicionais poderiam melhorar a explicação do OEE.

Importante:
- não trate associação como causalidade;
- não invente fatos não presentes nos resultados;
- escreva em português claro e técnico.
